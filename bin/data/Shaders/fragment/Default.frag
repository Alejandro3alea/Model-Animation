...
void main()
{
	...
	vec3 currNormal = uMaterial.isUsingSpecularSampler ? normalTexel : inVar.normal;
	vec3 fragPos = uMaterial.isUsingSpecularSampler ? inVar.tan_surfacePos : inVar.fragPos;
	vec3 viewPos = uMaterial.isUsingSpecularSampler ? inVar.tan_viewPos : uViewPos;
	...
	{
		vec3 lightPos = uMaterial.isUsingSpecularSampler ? inVar.tan_lightPos[i] : uLight[i].position;
